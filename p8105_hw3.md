...
![](p8105_hw3_files/figure-gfm/unnamed-chunk-14-1.png)<!-- --> It is
observed from the plot that for both male and female, the age gets
...
![](p8105_hw3_files/figure-gfm/unnamed-chunk-16-1.png)<!-- --> Across
all education levels, activity tends to peak in the morning (around 7am
to 1 pm) and around 6 to 11 pm) for both groups. For the group with
education level more than high school, male group shows greater
variability, with more pronounced peaks in activity and more outliers,
such as some individuals like to have high activity level at about 8 to
10 pm. Male and female group generally shows similar activities for all
