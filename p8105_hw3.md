...
From the table and the plot , it shows that for the category “less than
high school” and “More than high school”, women and men shows about the
...
aggregated_data |>ggplot(aes(x=age,y=total,color=sex))+
  ...
  labs(title = "Total Activity by Different Age, Sex and Education Level",
       x = "age ",
       y = "total activity ") +  theme_minimal()
```
